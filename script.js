...
function getRandomNumber(){
  ...
  let randomNumber = Math.random();
    //removes the decimal places from the number
...
function showYouWon(numberGuess){
  const text = numberGuess + " is correct! Awesome job, you got it!"
  /**
...
function showNumberAbove(numberGuess){
  const text = numberGuess + " is too high!"
  /**
   * Retrieve the dialog using the getDialog() function
   * and save it to variable called dialog
...
function showNumberBelow(numberGuess){
  const text = numberGuess + " is too low!"
  /**
   * Retrieve the dialog using the getDialog() function
   * and save it to variable called dialog
   * HINT: Use the 'warning' and text parameters 
